...
- Projects and written portions should have several functions and abstraction.  
- Be detailed in each and every part. 
- Not having one detail can throw you off and make you miss the whole point. 
- Meeting all the criteria is crucial and essential to receiving the point. 
- Work with purpose and intention while you diligently work. 